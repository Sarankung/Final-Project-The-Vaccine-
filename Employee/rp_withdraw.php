            ...
            <td width="806"><div align="center">
              ...
              <form action="login_process.php" method="post" name="form2" id="form2">
                <table width="525" border="1" align="center" cellspacing="0" bordercolor="#666666" bgcolor="#8DB6DD">
                  <tr>
                    <td colspan="2"><div align="center" class="style7 style15 style48">รายงานข้อมูลการเบิกยาและเวชภัณฑ์</div></td>
                  </tr>
                  <tr>
                    <td width="341"><span class="style50">รายการยาและเวชภัณฑ์ที่ต้องการเบิก</span></td>
                    <td width="174"><span class="style50">&nbsp;จำนวน</span></td>
                  </tr>
                  <?
			$sql_buy="SELECT * 
					FROM withdraw w
					INNER JOIN drug d ON w.drug_id = d.drug_id
					INNER JOIN user_tb e ON w.emp_id = e.id";
